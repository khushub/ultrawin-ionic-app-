...
export const RulesRegulations = [
  {
    ...
    rules: [
      `All ${BRAND_NAME} users including ‘Super’, ‘Master’ and ‘Sub’ account holders are advised to read the following ‘Terms and Conditions’. All users who use ${BRAND_NAME} agree and accept to the following: `,
      `1. The site www.${BRAND_NAME}.live and all of its original content are the sole property of and are, as such, fully protected by International Copyright and other intellectual property rights laws.`,
      `2. Any form of ‘Passing of funds’, ‘Self Matching’ will not be tolerated on ${BRAND_NAME}. Any users found participating in such activites will be locked with the funds being reversed. Accounts participating in such activities must note that ${BRAND_NAME} reserves the right to Void any bets of such nature at any time within 1 week of the bet being placed.`,
      ...
      `4. Please note that if any account has been locked due to ‘Passing of funds’ within the last 72 hours, ${BRAND_NAME} reserves the right to void any bet of this nature within the account irrespective of when the bet was placed.`,
      `5. No Arguments or claim in the above context will be entertained by ${BRAND_NAME} and the decision made by ${BRAND_NAME} will stand as final.`,
      `6. ${BRAND_NAME} Endeavors to have our services run 24 hours a day. However due to any technical issue, or disruption of services from our provider (Betfair.com), ${BRAND_NAME} will not be liable for any market positions that any account holders may hold.`,
      `7. Betfair.com reserves the right to resettle or void any market for reasons such as technical delayed suspension from the provider. In any such case ${BRAND_NAME} will settle according to Betfair.com`,
      ...
      `10.Any bets which are deemed of being suspicious, including bets which have been placed from the stadium or from a source at the stadium maybe voided at anytime. The decision of whether to void the particular bet in question or to void the entire market will remain at the discretion of ${BRAND_NAME}. The final decision of whether bets are suspicious will be taken by ${BRAND_NAME} and that decision will be full and final.`,
      `11. Any sort of cheating bet , any sort of Matching (Passing of funds), Court Siding (Ghaobaazi on commentary), Sharpening, Commission making is not allowed in ${BRAND_NAME}, If any ${BRAND_NAME} User is caught in any of such act then all the funds belonging that account would be seized and confiscated. No argument or claim in that context would be entertained and the decision made by ${BRAND_NAME} management will stand as final authority.`,

      `12. Fluke hunting/Seeking is prohibited in ${BRAND_NAME}, All the fluke bets will be reversed. Cricket commentary is just an additional feature and facility for ${BRAND_NAME} user but ${BRAND_NAME} is not responsible for any delay or mistake in commentary.`,
